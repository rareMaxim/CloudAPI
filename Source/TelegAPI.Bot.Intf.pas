...
{$REGION 'Getting updates'}
    /// <summary>
    ///   <para>
    ///     Èñïîëüçóéòå ýòîò ìåòîä äëÿ ïîëó÷åíèÿ îáíîâëåíèé èñïîëüçóÿ long
    ///     polling.
    ///   </para>
    ///   <para>
    ...
    /// </param>
    /// <param name="Limit">
    ///   Êîëè÷åñòâî îáíîâëåíèé êîòîðûå ìîãóò ïðèéòè â îäíîì çàïðîñå.
    ///   Äîïóñòèìîå çíà÷åíèå îò 1 äî 100. Ïî óìîë÷àíèþ - 100.Limits the number
...
{$REGION 'Basic methods'}
    /// <summary>
    ///   <para>
    ///     Ïðîñòîé ìåòîä äëÿ ïðîâåðêè òîêåíà âàøåãî áîòà
    ///   </para>
    ///   <para>
    ...
    /// <returns>
    ///   <para>
    ///     Âîçâðàùàåò îñíîâíóþ èíôîðìàöèþ î áîòå
    ///   </para>
    ///   <para>
    ...
    /// LMessage: TtgMessage;
    /// Begin
    /// //Åñëè íå èçâåñòåí ÈÄ ôàéëà
    /// LMessage := sendPhoto(chatId, TtgFileToSend.Create('Ïóòü ê ôàéëó'), nil);
    /// //Åñëè èçâåñòåí ÈÄ ôàéëà
    /// LMessage := sendPhoto(chatId, 'ÈÄ Ôàéëà');
    /// ...
    /// LMessage.Free;
    /// End; </code>
    /// </example>
