...
begin
  ...
  GetRequest.AutoReplace//
  {}.AddPair('<\br>', System.sLineBreak)//
  {}.AddPair('\n', System.sLineBreak)//
{};
...
function TTelegramBot.SendAnimation(const ChatId: TtgUserLink; const Animation,
  Thumb: TFileToSend; const Caption: string; const ParseMode: TtgParseMode;
...
function TTelegramBot.SendAudio(const ChatId: TtgUserLink; const Audio:
  TFileToSend; const Thumb: TFileToSend; const Caption: string; const ParseMode:
  TtgParseMode; const Duration: Int64; const Performer, Title: string; const
  DisableNotification: Boolean; const ReplyToMessageId: Int64; ReplyMarkup: IReplyMarkup): ITgMessage;
begin
  with GetRequest do
  begin
