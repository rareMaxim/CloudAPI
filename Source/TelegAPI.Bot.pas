...
{$REGION 'Getting updates'}
    ...
    // MaxConnections: Int64 = 40;
    // AllowedUpdates: TAllowedUpdates = UPDATES_ALLOWED_ALL);
    /// <summary>
...
{$REGION 'Basic methods'}
    ...
    /// </summary>
    /// <param name="ChatId">
    /// Int64 or String. Unique identifier for the target chat or username
    ...
    /// is returned.
    /// </returns>
    // function SendMessage(const ChatId: TValue; const Text: string;
    // ParseMode: TtgParseMode = TtgParseMode.Default;
    // DisableWebPagePreview: Boolean = False;
    // DisableNotification: Boolean = False; ReplyToMessageId: Int64 = 0;
    ...
    /// </returns>
    // function ForwardMessage(ChatId: TValue; FromChatId: TValue;
    // MessageId: Int64; DisableNotification: Boolean = False): TTgMessage;
    /// <summary>
    ...
    // const Caption: string = ''; DisableNotification: Boolean = False;
    // ReplyToMessageId: Int64 = 0; ReplyMarkup: IReplyMarkup = nil): TTgMessage;
    /// <summary>
    ...
    // /// </remarks>
    // function SendAudio(ChatId: TValue; Audio: TValue;
    // const Caption: string = ''; Duration: Int64 = 0;
    // const Performer: string = ''; DisableNotification: Boolean = False;
    // ReplyToMessageId: Int64 = 0; ReplyMarkup: IReplyMarkup = nil): TTgMessage;
    // /// <summary>
    ...
    /// </remarks>
    // function SendDocument(ChatId: TValue; Document: TValue;
    // const Caption: string = ''; DisableNotification: Boolean = False;
    // ReplyToMessageId: Int64 = 0; ReplyMarkup: IReplyMarkup = nil): TTgMessage;
    /// <summary>
    ...
    /// </remarks>
    // function SendVideo(ChatId: TValue; Video: TValue;
    // const Caption: string = ''; Duration: Int64 = 0; Width: Int64 = 0;
    // Height: Int64 = 0; DisableNotification: Boolean = False;
    // ReplyToMessageId: Int64 = 0; ReplyMarkup: IReplyMarkup = nil): TTgMessage;
    ...
    /// limit may be changed in the future.
    /// </remarks>
    // function SendVoice(ChatId: TValue; Voice: TValue;
    // const Caption: string = ''; Duration: Int64 = 0;
    // DisableNotification: Boolean = False; ReplyToMessageId: Int64 = 0;
    // ReplyMarkup: IReplyMarkup = nil): TTgMessage;
    /// <summary>
    ...
    // /// is returned.
    // /// </returns>
    // function SendLocation(ChatId: TValue; Location: TtgLocation;
    // LivePeriod: Int64 = 0; DisableNotification: Boolean = False;
    // ReplyToMessageId: Int64 = 0; ReplyMarkup: IReplyMarkup = nil): TTgMessage;
    // /// <summary>
    ...
    // /// On success, the sent Message is returned.
    // /// </returns>
    // function SendVenue(ChatId: TValue; Venue: TtgVenue;
    // DisableNotification: Boolean = False; ReplyToMessageId: Int64 = 0;
    // ReplyMarkup: IReplyMarkup = nil): TTgMessage;
    // /// <summary>
    ...
    // function SendContact(ChatId: TValue; Contact: TtgContact;
    // DisableNotification: Boolean = False; ReplyToMessageId: Int64 = 0;
    // ReplyMarkup: IReplyMarkup = nil): TTgMessage;
    // /// <summary>
    ...
    // function GetUserProfilePhotos(ChatId: TValue; Offset: Int64;
    // Limit: Int64 = 100): TtgUserProfilePhotos;
    // /// <summary>
    ...
    // function KickChatMember(ChatId: TValue; UserId: Int64;
    // UntilDate: Int64 = 0): Boolean;
    // /// <summary>
    ...
    // const Url: string = ''; CacheTime: Int64 = 0): Boolean;
    // {$ENDREGION}
    ...
    // function EditMessageText(ChatId: TValue; MessageId: Int64;
    // const Text: string; ParseMode: TtgParseMode = TtgParseMode.Default;
    // DisableWebPagePreview: Boolean = False; ReplyMarkup: IReplyMarkup = nil)
    // : TTgMessage; overload;
    ...
    // function EditMessageCaption(ChatId: TValue; MessageId: Int64;
    // const Caption: string; ReplyMarkup: IReplyMarkup = nil): Boolean;
    // overload;
    // { TODO -oM.E.Sysoev -cGeneral : Create Documentatiom }
    // function EditMessageCaption(const InlineMessageId: string;
    // const Caption: string; ReplyMarkup: IReplyMarkup = nil): Boolean;
    // overload;
    //
    // /// <summary>
    ...
    // /// </returns>
    // function editMessageLiveLocation(ChatId: TValue; MessageId: Int64;
    // Location: TtgLocation; ReplyMarkup: IReplyMarkup = nil): Boolean;
    // overload;
    // /// <summary>
    // /// Use this method to edit live location messages sent by the bot or via
    // /// the bot (for inline bots). A location can be edited until its
    ...
    // /// Message is returned, otherwise True is returned.
    // /// </returns>
    // function editMessageLiveLocation(const InlineMessageId: string;
    // Location: TtgLocation; ReplyMarkup: IReplyMarkup = nil): Boolean;
    // overload;
    //
    // /// <summary>
    ...
    // /// </returns>
    // function stopMessageLiveLocation(ChatId: TValue; MessageId: Int64;
    ...
    // /// returned, otherwise True is returned.
    // /// </returns>
    // function stopMessageLiveLocation(const InlineMessageId: string;
    // ReplyMarkup: IReplyMarkup = nil): Boolean; overload;
    // /// <summary>
    ...
    // /// is returned, otherwise True is returned.
    // /// </returns>
    // function EditMessageReplyMarkup(ChatId: TValue; MessageId: Int64;
    // ReplyMarkup: IReplyMarkup = nil): TTgMessage; overload;
    // /// <summary>
    // /// Use this method to edit only the reply markup of messages sent by the
    // /// bot or via the bot (for inline bots).
    // /// </summary>
    ...
    // /// is returned, otherwise True is returned.
    // /// </returns>
    // function EditMessageReplyMarkup(const InlineMessageId: string;
    // ReplyMarkup: IReplyMarkup = nil): TTgMessage; overload;
    // /// <summary>
    ...
    // Results: TArray<TtgInlineQueryResult>; CacheTime: Int64 = 300;
    ...
    // function SendInvoice(ChatId: Int64; const title: string;
    ...
    // const PhotoUrl: string = ''; PhotoSize: Int64 = 0; PhotoWidth: Int64 = 0;
    // PhotoHeight: Int64 = 0; NeedName: Boolean = False;
    // NeedPhoneNumber: Boolean = False; NeedEmail: Boolean = False;
    // NeedShippingAddress: Boolean = False; IsFlexible: Boolean = False;
    // DisableNotification: Boolean = False; ReplyToMessageId: Int64 = 0;
    // ReplyMarkup: IReplyMarkup = nil): TTgMessage;
    // /// <summary>
    ...
    // function AnswerShippingQuery(const ShippingQueryId: string; Ok: Boolean;
    // ShippingOptions: TArray<TtgShippingOption>;
    ...
    // function SendGame(ChatId: Int64; const GameShortName: string;
    // DisableNotification: Boolean = False; ReplyToMessageId: Int64 = 0;
    // ReplyMarkup: IReplyMarkup = nil): TTgMessage;
    // /// <summary>
    ...
    // function SetGameScore(UserId: Int64; Score: Int64; Force: Boolean = False;
    // DisableEditMessage: Boolean = False; ChatId: Int64 = 0;
    // MessageId: Int64 = 0; const InlineMessageId: string = ''): TTgMessage;
    // /// <summary>
    ...
    // /// Official API
    // /// </seealso>
    // function GetGameHighScores(UserId: Int64; ChatId: Int64 = 0;
    // MessageId: Int64 = 0; const InlineMessageId: string = '')
    ...
    // /// Returns True on success.
    // /// </returns>
    // function PinChatMessage(ChatId: TValue; MessageId: Int64;
    ...
    // /// Returns True on success.
    // /// </returns>
    // function SetChatDescription(ChatId: TValue;
    ...
    // /// Returns True on success.
    // /// </returns>
    // function RestrictChatMember(ChatId: TValue; UserId: Int64;
    // UntilDate: Int64 = 0; CanSendMessages: Boolean = False;
    ...
    // /// Returns True on success.
    // /// </returns>
    // function PromoteChatMember(ChatId: TValue; UserId: Int64;
    // CanChangeInfo: Boolean = False; CanPostMessages: Boolean = False;
    // CanEditMessages: Boolean = False; CanDeleteMessages: Boolean = False;
    // CanInviteUsers: Boolean = False; CanRestrictMembers: Boolean = False;
    ...
    // /// On success, the sent Message is returned.
    // /// </returns>
    // function SendSticker(ChatId: TValue; Sticker: TValue;
    // DisableNotification: Boolean = False; ReplyToMessageId: Int64 = 0;
    // ReplyMarkup: IReplyMarkup = nil): TTgMessage;
    // /// <summary>
    ...
    // /// success.
    // /// </returns>
    // function uploadStickerFile(UserId: Int64;
    // PngSticker: TtgFileToSend): TtgFile;
    // /// <summary>
    ...
    // /// Returns True on success.
    // /// </returns>
    // function createNewStickerSet(UserId: Int64; const Name, title: string;
    // PngSticker: TValue; const Emojis: string; ContainsMasks: Boolean = False;
    ...
    // /// Returns True on success.
    // /// </returns>
    // function addStickerToSet(UserId: Int64; const Name: string;
    // PngSticker: TValue; const Emojis: string;
    // MaskPosition: TtgMaskPosition = nil): Boolean;
    // /// <summary>
    ...
    // /// </remarks>
    // function setChatStickerSet(ChatId: TValue;
...
// MaxConnections: Int64; AllowedUpdates: TAllowedUpdates);
// var
...
// end;
//
// function TTelegramBot.stopMessageLiveLocation(ChatId: TValue; MessageId: Int64;
...
// end;
//
// function TTelegramBot.SendLocation(ChatId: TValue; Location: TtgLocation;
// LivePeriod: Int64; DisableNotification: Boolean; ReplyToMessageId: Int64;
// ReplyMarkup: IReplyMarkup): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
// begin
// Parameters := TDictionary<string, TValue>.Create;
...
// DisableNotification: Boolean; ReplyToMessageId: Int64;
// ReplyMarkup: IReplyMarkup): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// end;
//
// function TTelegramBot.SendSticker(ChatId, Sticker: TValue;
// DisableNotification: Boolean; ReplyToMessageId: Int64;
// ReplyMarkup: IReplyMarkup): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
...
// end;
//
// function TTelegramBot.SendMessage(const ChatId: TValue; const Text: string;
// ParseMode: TtgParseMode; DisableWebPagePreview, DisableNotification: Boolean;
// ReplyToMessageId: Int64; ReplyMarkup: IReplyMarkup): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
// begin
// Parameters := TDictionary<string, TValue>.Create;
...
// end;
//
// function TTelegramBot.SendVenue(ChatId: TValue; Venue: TtgVenue;
// DisableNotification: Boolean; ReplyToMessageId: Int64;
// ReplyMarkup: IReplyMarkup): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
...
// end;
//
// function TTelegramBot.SendVideo(ChatId, Video: TValue; const Caption: string;
// Duration, Width, Height: Int64; DisableNotification: Boolean;
// ReplyToMessageId: Int64; ReplyMarkup: IReplyMarkup): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// end;
//
// function TTelegramBot.SendVideoNote(ChatId, VideoNote: TValue;
// Duration, Length: Int64; DisableNotification: Boolean; ReplyToMessageId: Int64;
// ReplyMarkup: IReplyMarkup): TTgMessage;
// var
...
// end;
//
// function TTelegramBot.SendVoice(ChatId, Voice: TValue; const Caption: string;
// Duration: Int64; DisableNotification: Boolean; ReplyToMessageId: Int64;
// ReplyMarkup: IReplyMarkup): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// end;
//
// function TTelegramBot.SendAudio(ChatId, Audio: TValue; const Caption: string;
// Duration: Int64; const Performer: string; DisableNotification: Boolean;
// ReplyToMessageId: Int64; ReplyMarkup: IReplyMarkup): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// end;
//
// procedure TTelegramBot.SendChatAction(ChatId: TValue;
...
// end;
//
// function TTelegramBot.SendContact(ChatId: TValue; Contact: TtgContact;
// DisableNotification: Boolean; ReplyToMessageId: Int64;
// ReplyMarkup: IReplyMarkup): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
...
// end;
//
// function TTelegramBot.SendDocument(ChatId, Document: TValue;
// const Caption: string; DisableNotification: Boolean; ReplyToMessageId: Int64;
// ReplyMarkup: IReplyMarkup): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// end;
//
// function TTelegramBot.KickChatMember(ChatId: TValue;
// UserId, UntilDate: Int64): Boolean;
// var
// Parameters: TDictionary<string, TValue>;
// begin
// Parameters := TDictionary<string, TValue>.Create;
...
// end;
//
// function TTelegramBot.GetUserProfilePhotos(ChatId: TValue; Offset, Limit: Int64)
...
// Parameters.Add('offset', Offset);
// Parameters.Add('limit', Limit);
// Result := RequestAPI<TtgUserProfilePhotos>('getUserProfilePhotos',
// Parameters);
// finally
// Parameters.Free;
// end;
...
// end;
//
// function TTelegramBot.ForwardMessage(ChatId, FromChatId: TValue;
// MessageId: Int64; DisableNotification: Boolean): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
// begin
// Parameters := TDictionary<string, TValue>.Create;
...
// end;
//
// function TTelegramBot.GetChatAdministrators(const ChatId: TValue)
...
// try
// Parameters.Add('chat_id', ChatId);
// Result := Self.RequestAPI < TArray < TtgChatMember >>
...
// end;
//
// function TTelegramBot.GetChatMember(ChatId: TValue; UserId: Int64)
// : TtgChatMember;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// try
// Parameters.Add('chat_id', ChatId);
// Result := Self.RequestAPI<Int64>('getChatMembersCount', Parameters);
// finally
// Parameters.Free;
// end;
// end;
...
// end;
//
// function TTelegramBot.addStickerToSet(UserId: Int64; const Name: string;
// PngSticker: TValue; const Emojis: string;
// MaskPosition: TtgMaskPosition): Boolean;
// var
// Parameters: TDictionary<string, TValue>;
// begin
// Parameters := TDictionary<string, TValue>.Create;
...
// ShowAlert: Boolean; const Url: string; CacheTime: Int64): Boolean;
// var
// Parameters: TDictionary<string, TValue>;
// begin
// Parameters := TDictionary<string, TValue>.Create;
...
// {$REGION 'Updating messages'}
//
// function TTelegramBot.EditMessageText(const InlineMessageId, Text: string;
// ParseMode: TtgParseMode; DisableWebPagePreview: Boolean;
// ReplyMarkup: IReplyMarkup): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// end;
//
// function TTelegramBot.EditMessageText(ChatId: TValue; MessageId: Int64;
// const Text: string; ParseMode: TtgParseMode; DisableWebPagePreview: Boolean;
// ReplyMarkup: IReplyMarkup): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// end;
//
// function TTelegramBot.EditMessageCaption(ChatId: TValue; MessageId: Int64;
// const Caption: string; ReplyMarkup: IReplyMarkup): Boolean;
// var
// Parameters: TDictionary<string, TValue>;
// begin
// Parameters := TDictionary<string, TValue>.Create;
...
// end;
//
// function TTelegramBot.editMessageLiveLocation(ChatId: TValue; MessageId: Int64;
// Location: TtgLocation; ReplyMarkup: IReplyMarkup): Boolean;
// var
// Parameters: TDictionary<string, TValue>;
// begin
// Parameters := TDictionary<string, TValue>.Create;
...
// end;
//
// function TTelegramBot.EditMessageReplyMarkup(ChatId: TValue; MessageId: Int64;
// ReplyMarkup: IReplyMarkup): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// {$REGION 'Inline mode'}
//
// function TTelegramBot.AnswerInlineQuery(const InlineQueryId: string;
// Results: TArray<TtgInlineQueryResult>; CacheTime: Int64; IsPersonal: Boolean;
// const NextOffset, SwitchPmText, SwitchPmParameter: string): Boolean;
// var
// Parameters: TDictionary<string, TValue>;
// begin
// Parameters := TDictionary<string, TValue>.Create;
...
// Parameters.Add('results', TJsonUtils.ArrayToJString<TtgInlineQueryResult>
// (Results));
// Parameters.Add('cache_time', CacheTime);
...
// {$REGION 'Payments'}
//
// function TTelegramBot.SendInvoice(ChatId: Int64; const title: string;
// const Description: string; const Payload: string; const ProviderToken: string;
// const StartParameter: string; const Currency: string;
// Prices: TArray<TtgLabeledPrice>; const PhotoUrl: string; PhotoSize: Int64;
// PhotoWidth: Int64; PhotoHeight: Int64; NeedName: Boolean;
// NeedPhoneNumber: Boolean; NeedEmail: Boolean; NeedShippingAddress: Boolean;
// IsFlexible: Boolean; DisableNotification: Boolean; ReplyToMessageId: Int64;
// ReplyMarkup: IReplyMarkup): TTgMessage;
// var
// LParameters: TDictionary<string, TValue>;
// begin
...
// LParameters.Add('prices',
// TJsonUtils.ArrayToJString<TtgLabeledPrice>(Prices));
...
// end;
//
// function TTelegramBot.AnswerPreCheckoutQuery(const PreCheckoutQueryId: string;
// Ok: Boolean; const ErrorMessage: string): Boolean;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// end;
//
// function TTelegramBot.AnswerShippingQuery(const ShippingQueryId: string;
// Ok: Boolean; ShippingOptions: TArray<TtgShippingOption>;
// const ErrorMessage: string): Boolean;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// TJsonUtils.ArrayToJString<TtgShippingOption>(ShippingOptions));
// Parameters.Add('Error_message', ErrorMessage);
...
// end;
//
// function TTelegramBot.createNewStickerSet(UserId: Int64;
// const Name, title: string; PngSticker: TValue; const Emojis: string;
// ContainsMasks: Boolean; MaskPosition: TtgMaskPosition): Boolean;
// var
// Parameters: TDictionary<string, TValue>;
// begin
// Parameters := TDictionary<string, TValue>.Create;
...
// {$REGION 'Games'}
//
// function TTelegramBot.SetGameScore(UserId, Score: Int64;
// Force, DisableEditMessage: Boolean; ChatId, MessageId: Int64;
// const InlineMessageId: string): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
// begin
// Parameters := TDictionary<string, TValue>.Create;
...
// end;
//
// function TTelegramBot.setStickerPositionInSet(const Sticker: string;
// Position: Int64): Boolean;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// end;
//
// function TTelegramBot.SendGame(ChatId: Int64; const GameShortName: string;
// DisableNotification: Boolean; ReplyToMessageId: Int64;
// ReplyMarkup: IReplyMarkup): TTgMessage;
// var
// Parameters: TDictionary<string, TValue>;
...
// end;
//
// function TTelegramBot.GetGameHighScores(UserId, ChatId, MessageId: Int64;
// const InlineMessageId: string): TArray<TtgGameHighScore>;
// var
// Parameters: TDictionary<string, TValue>;
// begin
// Parameters := TDictionary<string, TValue>.Create;
...
// Parameters.Add('message_id', MessageId);
// Parameters.Add('inline_message_id', InlineMessageId);
// Result := RequestAPI < TArray < TtgGameHighScore >> ('getGameHighScores',
// Parameters);
// finally
// Parameters.Free;
// end;
...
// end;
//
// function TTelegramBot.PinChatMessage(ChatId: TValue; MessageId: Int64;
...
// end;
//
// function TTelegramBot.SetChatDescription(ChatId: TValue;
// const Description: string): Boolean;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// end;
//
// function TTelegramBot.SetChatPhoto(ChatId: TValue;
// Photo: TtgFileToSend): Boolean;
// var
// Parameters: TDictionary<string, TValue>;
// begin
// Parameters := TDictionary<string, TValue>.Create;
...
// end;
//
// function TTelegramBot.setChatStickerSet(ChatId: TValue;
// const StickerSetName: string): Boolean;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// end;
//
// function TTelegramBot.SetChatTitle(ChatId: TValue; const title: string)
// : Boolean;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// end;
//
// function TTelegramBot.uploadStickerFile(UserId: Int64;
// PngSticker: TtgFileToSend): TtgFile;
// var
// Parameters: TDictionary<string, TValue>;
// begin
...
// {$REGION 'Manage users and admins'}
//
// function TTelegramBot.PromoteChatMember(ChatId: TValue; UserId: Int64;
// CanChangeInfo, CanPostMessages, CanEditMessages, CanDeleteMessages,
...
// end;
//
// function TTelegramBot.RestrictChatMember(ChatId: TValue;
// UserId, UntilDate: Int64; CanSendMessages, CanSendMediaMessages,
